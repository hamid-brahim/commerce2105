 ...
 */
package be.canguru.cangucommerce.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, CangucommerceFulfilmentProcessConstants.PARENT_PROCESS);
