...
import be.canguru.cangucommerce.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link be.canguru.cangucommerce.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
