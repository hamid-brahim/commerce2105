 ...
 */
package be.canguru.cangucommerce.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CangucommerceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CangucommerceFulfilmentProcessConstants.PARENT_PROCESS);
