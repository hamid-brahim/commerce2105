...
import be.canguru.cangucommerce.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link be.canguru.cangucommerce.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
