 ...
 */
package be.canguru.cangucommerce.fulfilmentprocess.test.jobs;
...
import be.canguru.cangucommerce.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CangucommerceFulfilmentProcessConstants.ORDER_PROCESS_NAME;
