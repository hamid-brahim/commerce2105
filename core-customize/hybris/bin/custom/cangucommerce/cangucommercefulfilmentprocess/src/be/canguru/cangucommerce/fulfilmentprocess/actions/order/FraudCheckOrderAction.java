 ...
 */
package be.canguru.cangucommerce.fulfilmentprocess.actions.order;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(CangucommerceFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(CangucommerceFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
