 ...
 */
package be.canguru.cangucommerce.test.setup;
...
import be.canguru.cangucommerce.test.constants.CangucommerceTestConstants;
import be.canguru.cangucommerce.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CangucommerceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cangucommercetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cangucommercetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/cangucommercetest/import/cstickets.impex");
			...
			importImpexFile(context, "/cangucommercetest/import/csquotes.impex");
		}
	}
}
