 ...
 */
package be.canguru.cangucommerce.core.suggestion;
...
import be.canguru.cangucommerce.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/cangucommercecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
