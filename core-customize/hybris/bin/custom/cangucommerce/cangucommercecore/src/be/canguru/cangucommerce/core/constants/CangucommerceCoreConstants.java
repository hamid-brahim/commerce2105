 ...
 */
package be.canguru.cangucommerce.core.constants;

/**
 * Global class for all CangucommerceCore constants. You can add global constants for your extension into this class.
 */
public final class CangucommerceCoreConstants extends GeneratedCangucommerceCoreConstants
{
	public static final String EXTENSIONNAME = "cangucommercecore";


	private CangucommerceCoreConstants()
	{
		//empty
	}
